# Endringslogg rekvisisjon av personundersøkelser

| Versjon        | Beskrivelse                 | Aktiv mottaker | Aktiv sender | Aktiv til |
|----------------|-----------------------------|----------------|--------------|-----------|
| Arbeidsversjon |                             |                |              |           |
| **1.2**        | pakkeId for sammenkobling   |                |              |           |
| **1.1**        | Samtykke til deling med KOG |                |              |           |
| **1.0**        | **Første versjon**          | 2024           | 2024         |           |

### 09.03.2025 Versjon 1.2 laget fra arbeidsversjon
pakkeId for sammenkobling av meldinger (f eks siktelse sammen med personundersøkelse)
